export function calculate_stats(json){
    ...
    let hp_name = json.stats[0].stat.name;
    let attack_name = json.stats[1].stat.name;
    let defense_name = json.stats[2].stat.name;
    let speed_name = json.stats[3].stat.name;
    ...
    let stats = [stats_names,stats_values,exp];
    console.log(stats_names)//mejor manejo así que con Object
    return stats
}
